		...
		<Paper sx={transparentCardStyle(theme)}>
			...
			>
				<Box sx={{ display: "flex", alignItems: "center" }}>
					<Security
						sx={{ color: theme.palette.secondary.main, mr: 1, fontSize: 20 }}
					/>
					<Typography
						variant="subtitle2"
						fontWeight={700}
			...
			<Stack
				spacing={1}
				sx={{ flex: 1, overflowY: "auto", maxHeight: "250px" }}
			>
					...
					>
						...
						<Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
							{Object.entries(prefs).map(([key, val]) => {
								const isMandatory =
									context === "CORP_PAGE" && key === "share_production";
								...
								const description =
									...
									"Toggle visibility for this data type.";
