...
export const RecipeSelector = ({
	...
	if (
		!material ||
		!material.inputRecipes ||
		material.inputRecipes.length === 0
	) {
		return (
	...
	return (
		<Box
			sx={{ p: 1, height: "100%", borderRadius: 1, background: "transparent" }}
		>
			<Typography
				variant="subtitle2"
			...
			<List sx={{ maxHeight: 300, overflowY: "auto", p: 0 }}>
				{recipes.map((recipe, index) => {
					const isSelected =
						selectedRecipe && selectedRecipe.processid === recipe.processid;
