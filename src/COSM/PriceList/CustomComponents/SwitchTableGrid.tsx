 ...
 */
const MaterialViewSwitch: React.FC<MaterialViewSwitchProps> = ({
	view,
	onChange,
}) => {
	return (
		...
		>
			<StyledToggleButton value="table">Table</StyledToggleButton>
			<StyledToggleButton value="grid">Grid</StyledToggleButton>
		</ToggleButtonGroup>
	);
};
