import { Grid, Card, CardContent, Typography, Box, Tooltip, useTheme, alpha } from "@mui/material";
                        ...
                        <Card sx={{ 
                            ...
                            <CardContent sx={{ 
                                ...
                                <Box display="flex" alignItems="center" justifyContent="center" gap={0.5} mb={0.5}>
                                    <Typography color="text.secondary" variant="caption" noWrap fontWeight="bold" fontSize="0.7rem">
                                        {item.title}
                                    </Typography>
                                    {item.icon && (
                                        <Box sx={{ color: item.color, opacity: 0.8, display: 'flex', '& svg': { fontSize: '0.9rem' } }}>
                                            {item.icon}
                                        </Box>
                                    )}
                                </Box>
