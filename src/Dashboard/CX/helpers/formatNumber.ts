// --- Formatter Helper ---
export const formatCompactNumber = (num: number, isCurrency: boolean = false, currencySymbol: string = 'ICA') => {
    ...
    return isCurrency ? `${formattedValue}${suffix} ${currencySymbol}` : `${formattedValue}${suffix}`;
};