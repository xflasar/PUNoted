...
export const getStatusColor = (status: string, theme: any) => {
  switch (status) {
    case 'FULFILLED': return theme.palette.success.main;
    ...
    case 'PARTIALLY_FULFILLED': return theme.palette.warning.main;
...
export const formatCurrency = (amount: number | string | undefined | null, currency: string = 'ICA') => {
