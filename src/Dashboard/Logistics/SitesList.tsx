...
import { Drawer, Box, Typography, IconButton, useTheme, TextField, InputAdornment } from '@mui/material';
...
const SitesList: React.FC<SitesListProps> = ({ sites, ships }) => {
    ...
    return (
        ...
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', flexGrow: 1, p: 2 }}>
            <TextField
                fullWidth
                variant="outlined"
            ...
            <Drawer
                ...
                PaperProps={{ sx: { width: { xs: '90%', md: '50%', lg: '40%' }, p: 2, backgroundColor: theme.palette.background.default } }}
            >
                {selectedSite && (
                    <Box>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, borderBottom: `1px solid ${theme.palette.divider}`, pb: 1 }}>
