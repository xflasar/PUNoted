...
export interface Site {
    ...
    dailyProduction: { materialTicker: string, amount: number, tonnage: number, volume: number }[];
    dailyConsumption: { materialTicker: string, amount: number, tonnage: number, volume: number }[];
}
