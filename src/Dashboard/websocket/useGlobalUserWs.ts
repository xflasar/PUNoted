 ...
 */
export const useGlobalWs = (channel?: string, onMessage?: (data: any) => void) => {
    const { subscribe, unsubscribe, addMessageListener, removeMessageListener, sendJson, status } = useGlobalWsContext();
