...
const InviteUserModal: React.FC<InviteUserModalProps> = ({ 
    ...
    const handleInvite = async () => {
        ...
        try {
            ...
            const isUserAlreadyMember = activeGroup!.members.some(m => m.username === identifier || m.uid === identifier);
            ...
            setError((e as Error).message || "Failed to send invitation. Please check the identifier.");
        } finally {
            setLoading(false);
        }
    };
        ...
        <Modal open={open} onClose={handleClose}>
            <Box sx={style}>
                ...
                <TextField
                    ...
                    onKeyPress={(e) => { if (e.key === 'Enter' && !loading) handleInvite(); }}
                    error={!!error}
                    helperText={error}
                    InputProps={{
