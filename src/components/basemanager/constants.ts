export const EXPERT_BONUS = [0, 0.0306, 0.0696, 0.1248, 0.1974, 0.284];
...
export const WORKER_NEEDS: Record<
	string,
...
export const FALLBACK_NEEDS: Record<
	string,
	{ essentials: string[]; luxuries: string[] }
> = {
	Pioneer: { essentials: ["RAT", "DW", "O2"], luxuries: [] },
...
export const FALLBACK_BUILDINGS = [
	...
	},
	{
		...
		type: "infrastructure",
		area: 50,
		buildReq: [{ ticker: "BBH", amount: 20 }],
		supply: { Technician: 100 },
	},
	{
		ticker: "HB4",
		name: "Eng Hab",
	...
	},
	{
		...
		type: "infrastructure",
		area: 50,
		buildReq: [{ ticker: "BBH", amount: 40 }],
		supply: { Scientist: 100 },
	},
	{
		ticker: "STO",
		name: "Storage",
