...
export const useViewNavigation = ({
    ...
    }, [centeredSystem, setCenteredSystem, setCurrentViewMode, setGalaxyViewState, ignoreOnViewStateChangeRef]);

    const transitionToSystemView = useCallback((system: MapPoint) => {
        ignoreOnViewStateChangeRef.current = true;
    ...
    }, [galaxyViewState.zoom, isGalaxyView, systemsPoints, centeredSystem, onSystemClick, mode]); 
